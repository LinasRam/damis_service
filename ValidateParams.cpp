...
{
    LOG(INFO) << "Validating MLP parameter h1pNo - " << h1pNo << " h2pNo - "<< h2pNo <<  " qty - " << qty << " kFoldValidation - " << validationMethod << " p - " << p << " maxIteration - " << maxIteration << " maxCalcTime - " << maxCalcTime;
